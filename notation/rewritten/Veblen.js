// ============================================================================
//  notation/Veblen.js — Extended Veblen's φ Function（极限 BHO）
// ============================================================================
//  移植自 ne-rewritten: src/notations/Misc/Veblen.ts
//  表达式：
//    0 = [0]；1 = [1, Expr[]]（和）；2 = [2, VeblenList, Expr]（φ 列表）
//    VeblenList = [VeblenList, Expr][]
//  id: veblen-phi
// ============================================================================
;(() => {
  const U = window.NEUTILS;
  const { bind2, boolean_compare, lex_compare, tuple_lex_compare_by, merge_sum } = U;
