(()=>{
   ...
   ,collect = working_entry=>(
      ...
      ?collect_strong(working_entry)
      :collect_weak(working_entry)
   )
      ...
      register.push({
         ...
         ,FS:(()=>{
            ...
            return (seq,FSterm)=>{
               ...
               return data[datakey][FSterm] = actual_magma(seq,FSterm).slice(0,-1)
            }
         })()
         ,FSalter:(()=>{
            var data={}
            return (seq,FSterm)=>{
               ...
               return data[datakey][FSterm] = actual_magma(seq,FSterm)
            }
         })()
         ,init:()=>([
            {expr:[Infinity],low:[[1]],subitems:[]}
